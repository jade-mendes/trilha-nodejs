...
import { MAX_USERNAME_SIZE, MIN_USERNAME_SIZE } from "@/constants/validation-constants.js";
...
export async function updateUser(request: FastifyRequest, reply: FastifyReply) {
  try {
    ...
    const updateBodySchema = z.object({
          name: z.string().trim().min(MIN_USERNAME_SIZE).max(MAX_USERNAME_SIZE).optional(),
